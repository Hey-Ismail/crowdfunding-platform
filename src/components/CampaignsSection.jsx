...
const CampaignsSection = () => {
  ...
  useEffect(() => {
    const fetchCampaigns = async () => {
      try {
        ...
        // Reverse to show newest first, or sort as needed
  ...
  // Sort campaigns by highest raised amount first (Top Funded) (Fallback to 0 if not set)
  const sortedTopCampaigns = [...campaigns].sort((a, b) => (b.raisedAmount || 0) - (a.raisedAmount || 0));
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-56 w-full overflow-hidden bg-slate-950">
                    <img
                      src={campaign.campaign_image_url || 'https://via.placeholder.com/400x300'}
                  ...
                  <div className="flex flex-1 flex-col justify-between p-6 space-y-4">
                    <div>
                      <div className="flex items-center justify-between text-xs font-semibold text-slate-400 mb-2">
                        <span className="text-emerald-400">{campaign.category || 'General'}</span>
                    ...
                    <div className="flex items-center justify-between pt-2">
                      <div className="flex items-center gap-2">
                        <img 
                          src={avatarUrl} 
                          alt={campaign.creator_name || 'Creator'}
                          className="h-7 w-7 rounded-full object-cover ring-1 ring-slate-700 bg-slate-800" 
                        />
